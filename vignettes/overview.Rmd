...
simple visualisation similar to the analysis in ETC5523. This vignette forms part of **ETC5523 Assignment 4: Turning analysis
interactive**. It shows how the `covidQuarantineViz` package wraps the
simulation outputs from the COVIDQuarantine model and reproduces key steps from
the earlier ETC5523 assignments in a reproducible and interactive way.
